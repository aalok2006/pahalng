...
// ------------------------------------------------------------------------
// Email Settings
define('RECIPIENT_EMAIL_EWASTE', "sahilsinghss@gmail.com");

// Email Sending Defaults
define('SENDER_EMAIL_DEFAULT', 'sahilsinghss@gmail.com');
define('SENDER_NAME_DEFAULT', 'PAHAL NGO E-Waste Program');
    ...
    if (!empty($_POST[HONEYPOT_FIELD_NAME]) || !validate_csrf_token($_POST[CSRF_TOKEN_NAME] ?? null)) {
     ...
     if ($submitted_form_id === 'ewaste_pickup_form') {
         ...
         $validator = validator($form_submissions[$form_id], [
            'pickup_name' => 'required|string|min:2|max:100',
            'pickup_email' => 'required_without:pickup_phone|nullable|email|max:255',
            'pickup_phone' => 'required_without:pickup_email|nullable|string|max:20',
            'pickup_address' => 'required|string|max:300',
            'pickup_items_desc' => 'required|string|min:10|max:1000',
            'pickup_quantity_estimate' => 'required|string|max:100',
...
<head>
    ...
    <meta property="og:url" content="https://your-pahal-domain.com/e-waste.php"/>
    <meta property="og:image" content="https://your-pahal-domain.com/images/ewaste-og.jpg"/>
